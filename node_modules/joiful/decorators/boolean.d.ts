...
export declare function getBooleanSchemaModifierProviders(getJoi: () => typeof Joi): ModifierProviders<Joi.BooleanSchema, BooleanSchemaModifiers>;
export interface BooleanSchemaDecorator extends BooleanSchemaModifiers, TypedPropertyDecorator<boolean> {
}
export declare const createBooleanPropertyDecorator: (joifulOptions: JoifulOptions) => import("./common").PropertyDecorator<Boolean, BooleanSchemaModifiers>;
