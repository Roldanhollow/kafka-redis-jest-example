...
declare const any: () => import("./decorators/common").PropertyDecorator<any, import("./decorators/any").AnySchemaModifiers>, array: (options?: import("./decorators/array").ArrayPropertyDecoratorOptions | undefined) => import("./decorators/common").PropertyDecorator<any[], import("./decorators/array").ArraySchemaModifiers>, boolean: () => import("./decorators/common").PropertyDecorator<Boolean, import("./decorators/boolean").BooleanSchemaModifiers>, date: () => import("./decorators/common").PropertyDecorator<Date, import("./decorators/date").DateSchemaModifiers>, func: () => import("./decorators/common").PropertyDecorator<Function, import("./decorators/function").FunctionSchemaModifiers>, joi: typeof import("@hapi/joi"), lazy: (getSchema: ({ joi }: {
    joi: typeof import("@hapi/joi");
}) => import("@hapi/joi").Schema) => import("./decorators/common").PropertyDecorator<any, import("./decorators/lazy").LazySchemaModifiers>, number: () => import("./decorators/common").PropertyDecorator<number, import("./decorators/number").NumberSchemaModifiers>, object: (options?: import("./decorators/object").ObjectPropertyDecoratorOptions | undefined) => import("./decorators/common").PropertyDecorator<object, import("./decorators/object").ObjectSchemaModifiers>, string: () => import("./decorators/common").PropertyDecorator<string, import("./decorators/string").StringSchemaModifiers>, validateParams: (options?: {
    validator?: Validator | undefined;
} | undefined) => MethodDecorator, getSchema: (Class: import("./core").AnyClass) => import("@hapi/joi").ObjectSchema | undefined, hasSchema: (Class: import("./core").AnyClass) => boolean;
export { any, array, boolean, date, func, joi, lazy, number, object, string, validate, validateAsClass, validateArrayAsClass, validateParams, getSchema, hasSchema, };
